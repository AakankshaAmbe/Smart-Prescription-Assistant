...
// ===============================
function getMessage(language, medicines, time, doseId) {
    ...
    try {
        ...
        for (let r of reminders) {
            ...
            for (let time of times) {
                ...
                // 📨 GENERATE MESSAGE
                const msg = getMessage(r.language, r.medicines, time, doseId);
